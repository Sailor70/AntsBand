...
def get_test_mean(params: dict):
    ...
    for i in range(10):
        ...
        if i == 1:
            ...
            midi_result.save("../data/results/midi_results/" + file_name)
...
def get_tests_results():
    ...
    # param_sets = [{'ant_count': 10, 'generations': 10, 'alpha': 1.0, 'beta': 5.0, 'rho': 0.5, 'q': 10, 'sigma': 10},
    ...
    ant_counts = [1, 5, 10, 30, 50]  # 100 to jest fest dużo
    ...
    # todo można zaapendować dodatkowe zestawy z np 150 generations i standardowym zestawem parametrów
