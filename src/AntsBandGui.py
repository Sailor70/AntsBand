...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        canvas = Canvas(master, width=650, height=350)
        ...
        self.exit_btn.grid(row=8, column=2, sticky='w')
...
if __name__ == '__main__':
    print('Welcome to AntsBand 1.0 - created by Paweł Chmielarski')
    print('This application generates music based on input midi files and with the use of ant colony optimisation algorithms.')
    root = tix.Tk()
    app = MainWindow(root)
    root.mainloop()
