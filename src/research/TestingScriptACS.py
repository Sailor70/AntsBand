...
# tym skryptem wykonano test acs. w dwóch iteracjach (parametry zakomentowano.
...
def get_test_mean(params: dict):
    ...
    for i in range(10):
        ...
        if i == 1:
            ...
            # midi_result.save('../data/results/results_acs/1/' + file_name)  # pierwsza faza
            midi_result.save('../../data/results/results_acs/2/' + file_name)
...
def get_tests_results():
    ...
    for i, params in enumerate(param_sets):
        ...
        if i % 50 == 0:  # dla bezpieczeństwa zapis co 50 testów
            ...
            df.to_csv('../../data/results/results_acs/antsBand_tests_acs2.csv',index=False)
